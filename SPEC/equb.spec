...
# =========================================
%{short_name}/bin/pip install %{SOURCE0}/backend
...
virtualenv-tools --update-path %{virtualenvs_location}%{short_name} %{buildroot}%{virtualenvs_location}%{short_name}
